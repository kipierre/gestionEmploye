...
import org.gestionemploye.dto.LeaveDTO;
...
import org.gestionemploye.exceptions.UnauthorizedRequest;
import org.gestionemploye.mapper.LeaveMapper;
...
public class LeaveService {
    ...
    public LeaveService(final LeaveRepository employeeLeaveRepository){
    ...
    public LeaveDTO createEmployeeLeave(LeaveDTO leaveDTO) {
        ...
        long employeeId = ExtractUserAuthentication.getCurrentUser().getEmployeeId();
    ...
    public LeaveDTO approveEmployeeLeave(LeaveDTO leaveDTO) {
        ...
        long approverId = ExtractUserAuthentication.getCurrentUser().getEmployeeId();
